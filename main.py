...
def run_pipeline(use_pickled_features=False, debug=False):
    ...
    # LightGBM partitioning of categoricals
...
def _parse_command_line():
    ...
    If a command line argument is specified, then the specified
    pipeline will run, otherwise the entire pipeline will be run.
    """
